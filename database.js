...
async function initDB() {
  ...
  try {
    ...
    const migrations = [
      ...
      `ALTER TABLE nc_internes ADD COLUMN IF NOT EXISTS num_cde_client VARCHAR(100)`,
      `ALTER TABLE nc_internes ADD COLUMN IF NOT EXISTS qte_refusee_inutilisable INTEGER`,
      `ALTER TABLE nc_internes ADD COLUMN IF NOT EXISTS qte_refusee_utilisable INTEGER`,
      `ALTER TABLE nc_internes ADD COLUMN IF NOT EXISTS qte_acceptee INTEGER`,
      `ALTER TABLE nc_internes ADD COLUMN IF NOT EXISTS cout_production NUMERIC(10,2) DEFAULT 0`,
      `ALTER TABLE nc_internes ADD COLUMN IF NOT EXISTS cout_matiere NUMERIC(10,2) DEFAULT 0`,
      `ALTER TABLE nc_internes ADD COLUMN IF NOT EXISTS cout_transport NUMERIC(10,2) DEFAULT 0`,
      `ALTER TABLE nc_internes ADD COLUMN IF NOT EXISTS cout_indirect NUMERIC(10,2) DEFAULT 0`,
      ...
      `ALTER TABLE nc_externes ADD COLUMN IF NOT EXISTS num_cde_client VARCHAR(100)`,
      `ALTER TABLE nc_externes ADD COLUMN IF NOT EXISTS qte_refusee_inutilisable INTEGER`,
      `ALTER TABLE nc_externes ADD COLUMN IF NOT EXISTS qte_refusee_utilisable INTEGER`,
      `ALTER TABLE nc_externes ADD COLUMN IF NOT EXISTS qte_acceptee INTEGER`,
      `ALTER TABLE nc_externes ADD COLUMN IF NOT EXISTS cout_production NUMERIC(10,2) DEFAULT 0`,
      `ALTER TABLE nc_externes ADD COLUMN IF NOT EXISTS cout_matiere NUMERIC(10,2) DEFAULT 0`,
      `ALTER TABLE nc_externes ADD COLUMN IF NOT EXISTS cout_transport NUMERIC(10,2) DEFAULT 0`,
      `ALTER TABLE nc_externes ADD COLUMN IF NOT EXISTS cout_indirect NUMERIC(10,2) DEFAULT 0`,
